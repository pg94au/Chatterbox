...
Scenario: A message is not delivered to non-target users or unregistered users
	...
	Then a registered event is received from C for "Charlie"
	And a user joined event is received from A for "Charlie"
	And a user joined event is received from B for "Charlie"
	And a user joined event is received from C for "Charlie"
